...
def upgrade():
    ...
    op.add_column('check', sa.Column('read_only', sa.Boolean(), nullable=False, default=False))
    op.add_column('data_source', sa.Column('parent_data_source_id', sa.Integer(), nullable=True))
    op.add_column('data_source', sa.Column('read_only', sa.Boolean(), nullable=False, default=False))
    op.add_column('job_template', sa.Column('parent_job_template_id', sa.Integer(), nullable=True))
    op.add_column('job_template', sa.Column('read_only', sa.Boolean(), nullable=False, default=False))
    op.add_column('rule', sa.Column('parent_rule_id', sa.Integer(), nullable=True))
    op.add_column('rule', sa.Column('read_only', sa.Boolean(), nullable=False, default=False))
